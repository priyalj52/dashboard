  ...
  return (
    <div>
      <div className="absolute top-[5rem] bg-[#F4F8F9]  w-full left-[3rem ] items-center">
        <div className="main-tab flex items-center justify-between flex-wrap p-5">
          <div className="left flex mt-2  gap-4">
            <div
              className="headings flex gap-2 bg-white ml-3 cursor-pointer p-2 text-xs md:text-sm"
              style={{ width: "80%" }}
            >
              <span className="hover:bg-[#026DFE]">Users</span>
              <span className="hover:bg-[#026DFE]">Campaign</span>
              <span className="hover:bg-[#026DFE]" onClick={handleToggleTable}>
                Tables
              </span>
            ...
            <button class="bg-white hover:bg-gray-100 text-gray-300 font-bold py-2 px-4 rounded md:inline-flex items-center hidden">
              <AiOutlineDownload />
              <span>Download</span>
            </button>
          </div>
          <div className="right mr-[10%] flex flex-wrap gap-2 items-center">
            <input
              ...
              class="bg-white hover:bg-gray-100 text-gray-300 font-semibold py-2 px-4 border border-gray-400 rounded shadow outline-none"
            />
        ...
        <div className=" tables border  bg-white grid grid-cols-4  justify-items-center mt-2 w-full  md:w-[80%] md:ml-[5%] p-4 rounded-md ">
          <span>Name</span>
          <span>Username</span>
          <span>Website</span>
          <span>Email</span>
